...
-- Schedule the Sora video generation polling to run every minute
SELECT cron.schedule(
  'sora-video-poll-every-minute',
  '* * * * *',
  $$
  SELECT
    net.http_post(
        url:='https://kopclhksdjbheypwsvxz.supabase.co/functions/v1/sora-poll-cron',
